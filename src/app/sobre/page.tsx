...
const AboutUs = () => {
    return (
        <div className="flex w-full p-8 flex-col move-in">
            <div className="w-full md:w-1/2">
                <h1 className="font-bold font-varela text-2xl sm:text-4xl lg:text-5xl xl:text-6xl mb-2">Sobre Nos</h1>
                <h2 className="font-sans text-[#757575] text-lg sm:text-xl lg:text-2xl xl:text-3xl tracking-wide fade-in tracking-wide lg:tracking-widest">Somos especialistas no completo desenvolvimento de projetos de impressão para embalagens, acompanhando cada etapa técnica e gráfica. Com mais de 20 anos de experiência, garantimos a adaptação da ideia criativa para diferentes processos de impressão, preservando a essência e originalidade da marca em cada detalhe.</h2>
            </div>
            ...
            <h1 className="font-bold font-varela text-2xl sm:text-4xl lg:text-5xl xl:text-6xl mb-2">Nossos valores</h1>
            <h2 className="font-sans text-[#757575] text-lg sm:text-xl lg:text-2xl xl:text-3xl  tracking-wide lg:tracking-widest fade-in">
            ...
            <div className=" w-full h-[250px] sm:h-[400px] relative w-[100vw] -mx-12 -mb-12 mt-20">
