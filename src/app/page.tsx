...
<Image src={"/processo.jpeg"} layout='fill' objectFit="cover" className="w-full" alt="foto Empresa" />   
            ...
            <hr />
            <div className="flex flex-col mx-auto space-y-4  sm:flex-row sm:mx-0 sm:space-y-0 sm:justify-around sm:space-x-2">
              <div className="relative w-[100px] h-[100px] sm:w-[100px] sm:h-[80px] md:w-[110px] md:h-[110px] lg:w-[160px] lg:h-[160px] xl:w-[120px] xl:h-[120px]">
              ...
              <div className="relative w-[100px] h-[100px] sm:w-[100px] sm:h-[80px] md:w-[110px] md:h-[110px] lg:w-[160px] lg:h-[160px] xl:w-[140px] xl:h-[140px]">
                <Link href={"https://www.jnj.com/"} target="_blank">
              <Image  src={"/johnson.png"} alt='johnson&johnson' layout="fill" objectFit="contain" className="cursor-pointer"/>
              </Link>
